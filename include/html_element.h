...
public:
    ...
    HTML5_PROPERTY_OBJECT(HTMLElement, HTMLMenuElement, contextMenu);
    HTML5_PROPERTY_OBJECT(HTMLElement, DOMStringMap, dataset);
    HTML5_PROPERTY(HTMLElement, std::string, dir);
    HTML5_PROPERTY(HTMLElement, bool, draggable);
    HTML5_PROPERTY_OBJECT(HTMLElement, DOMSettableTokenList, dropzone);
    ...
    HTML5_PROPERTY_OBJECT(HTMLElement, DOMSettableTokenList, itemProp);
    HTML5_PROPERTY_OBJECT(HTMLElement, DOMSettableTokenList, itemRef);
    HTML5_PROPERTY(HTMLElement, bool, itemScope);
    HTML5_PROPERTY_OBJECT(HTMLElement, DOMSettableTokenList, itemType);
    ...
    HTML5_PROPERTY_OBJECT(HTMLElement, HTMLPropertiesCollection, properties);
    HTML5_PROPERTY(HTMLElement, bool, spellcheck);
    HTML5_PROPERTY_OBJECT(HTMLElement, CSSStyleDeclaration, style);
